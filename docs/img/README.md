...
| --- | --- | --- |
| `dashboard.png` | A scan result: cost total, risk badges, alerts panel | root `README.md` — hero image and Screenshots |
| `history-diff.png` | The scan-history sidebar and the diff between two scans | root `README.md` — Screenshots |
| `cleanup-preview.png` | The guided cleanup panel mid dry-run | root `README.md` — Screenshots |
...
To record a new one, `docs/DEMO.md` has the sequence.
